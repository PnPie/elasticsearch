...
public class ExplainResponse extends ActionResponse implements ToXContentObject {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (hasExplanation()) {
            ...
            detailsToXContect(builder, params, explanation.getDetails());
            builder.endObject();
        }
        if (getResult != null) {
    ...
    private void detailsToXContect(XContentBuilder builder, Params params, Explanation[] explanations) throws IOException {
